...
-->
  ...
  <body>
    <div class="content_wrapper">
      <h3>Les écoles segondaires -catégorie batiments sanitaires</h3>
      <h3>Motema Pembe
        <!-- voting markup -->
        ...
        <!-- voting markup end --> </h3>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vel leo
      mauris, eget congue augue. Nulla luctus elit et ante blandit non eleifend
      massa auctor. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      Etiam quis quam at nunc egestas consequat. Donec pretium enim magna, eget
      egestas enim.
      <h3>Sacré Coeur
        <!-- voting markup -->
        ...
        <!-- voting markup end --> </h3>
      Praesent fermentum erat mauris, a rutrum eros. Curabitur pellentesque
      vulputate sapien. In tincidunt est vitae leo rutrum lacinia. Cras id lorem
      sem, non adipiscing leo. Duis lobortis egestas pellentesque. In blandit
      tortor at lectus sodales tempor.
      <h3>Lupio
        <!-- voting markup -->
